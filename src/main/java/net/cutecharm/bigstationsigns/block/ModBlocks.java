...
public class ModBlocks {
    ...
    public static final Block STANDING_GRAY_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "gray_standing_sign_b"),
            new TerraformSignBlock(SmallSignTextureHelper.GRAY_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_GRAY_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_GRAY_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "gray_wall_sign_b"),
            new TerraformWallSignBlock(SmallSignTextureHelper.GRAY_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_GRAY_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block STANDING_GRAY_SIGN_C = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "gray_standing_sign_c"),
            new TerraformSignBlock(SmallSignTextureHelper.GRAY_SIGN_TEXTURE_C, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_GRAY_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_GRAY_SIGN_C = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "gray_wall_sign_c"),
            new TerraformWallSignBlock(SmallSignTextureHelper.GRAY_SIGN_TEXTURE_C, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_GRAY_SIGN).noCollision().noBlockBreakParticles()));
    ...
    public static final Block STANDING_GREEN_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "green_standing_sign_b"),
            new TerraformSignBlock(SmallSignTextureHelper.GREEN_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_GREEN_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_GREEN_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "green_wall_sign_b"),
            new TerraformWallSignBlock(SmallSignTextureHelper.GREEN_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_GREEN_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block STANDING_GREEN_SIGN_C = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "green_standing_sign_c"),
            new TerraformSignBlock(SmallSignTextureHelper.GREEN_SIGN_TEXTURE_C, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_GREEN_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_GREEN_SIGN_C = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "green_wall_sign_c"),
            new TerraformWallSignBlock(SmallSignTextureHelper.GREEN_SIGN_TEXTURE_C, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_GREEN_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block STANDING_GREEN_SIGN_D = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "green_standing_sign_d"),
            new TerraformSignBlock(SmallSignTextureHelper.GREEN_SIGN_TEXTURE_D, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_GREEN_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_GREEN_SIGN_D = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "green_wall_sign_d"),
            new TerraformWallSignBlock(SmallSignTextureHelper.GREEN_SIGN_TEXTURE_D, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_GREEN_SIGN).noCollision().noBlockBreakParticles()));
    ...
    public static final Block STANDING_LIME_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "lime_standing_sign_b"),
            new TerraformSignBlock(SmallSignTextureHelper.LIME_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_LIME_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_LIME_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "lime_wall_sign_b"),
            new TerraformWallSignBlock(SmallSignTextureHelper.LIME_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_LIME_SIGN).noCollision().noBlockBreakParticles()));
    ...
    public static final Block STANDING_PURPLE_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "purple_standing_sign_b"),
            new TerraformSignBlock(SmallSignTextureHelper.PURPLE_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_PURPLE_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_PURPLE_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "purple_wall_sign_b"),
            new TerraformWallSignBlock(SmallSignTextureHelper.PURPLE_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_PURPLE_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block STANDING_PURPLE_SIGN_C = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "purple_standing_sign_c"),
            new TerraformSignBlock(SmallSignTextureHelper.PURPLE_SIGN_TEXTURE_C, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_PURPLE_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_PURPLE_SIGN_C = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "purple_wall_sign_c"),
            new TerraformWallSignBlock(SmallSignTextureHelper.PURPLE_SIGN_TEXTURE_C, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_PURPLE_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block STANDING_PURPLE_SIGN_D = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "purple_standing_sign_d"),
            new TerraformSignBlock(SmallSignTextureHelper.PURPLE_SIGN_TEXTURE_D, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_PURPLE_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_PURPLE_SIGN_D = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "purple_wall_sign_d"),
            new TerraformWallSignBlock(SmallSignTextureHelper.PURPLE_SIGN_TEXTURE_D, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_PURPLE_SIGN).noCollision().noBlockBreakParticles()));
    ...
    public static final Block STANDING_PINK_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "pink_standing_sign_b"),
            new TerraformSignBlock(SmallSignTextureHelper.PINK_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_PINK_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_PINK_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "pink_wall_sign_b"),
            new TerraformWallSignBlock(SmallSignTextureHelper.PINK_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_PINK_SIGN).noCollision().noBlockBreakParticles()));
    ...
    public static final Block STANDING_CYAN_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "cyan_standing_sign_b"),
            new TerraformSignBlock(SmallSignTextureHelper.CYAN_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_CYAN_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_CYAN_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "cyan_wall_sign_b"),
            new TerraformWallSignBlock(SmallSignTextureHelper.CYAN_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_CYAN_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block STANDING_CYAN_SIGN_C = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "cyan_standing_sign_c"),
            new TerraformSignBlock(SmallSignTextureHelper.CYAN_SIGN_TEXTURE_C, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_CYAN_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_CYAN_SIGN_C = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "cyan_wall_sign_c"),
            new TerraformWallSignBlock(SmallSignTextureHelper.CYAN_SIGN_TEXTURE_C, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_CYAN_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block STANDING_CYAN_SIGN_D = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "cyan_standing_sign_d"),
            new TerraformSignBlock(SmallSignTextureHelper.CYAN_SIGN_TEXTURE_D, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_CYAN_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_CYAN_SIGN_D = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "cyan_wall_sign_d"),
            new TerraformWallSignBlock(SmallSignTextureHelper.CYAN_SIGN_TEXTURE_D, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_CYAN_SIGN).noCollision().noBlockBreakParticles()));
    ...
    public static final Block STANDING_BLACK_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "black_standing_sign_b"),
            new TerraformSignBlock(SmallSignTextureHelper.BLACK_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_BLACK_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_BLACK_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "black_wall_sign_b"),
            new TerraformWallSignBlock(SmallSignTextureHelper.BLACK_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_BLACK_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block STANDING_BLACK_SIGN_C = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "black_standing_sign_c"),
            new TerraformSignBlock(SmallSignTextureHelper.BLACK_SIGN_TEXTURE_C, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_BLACK_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_BLACK_SIGN_C = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "black_wall_sign_c"),
            new TerraformWallSignBlock(SmallSignTextureHelper.BLACK_SIGN_TEXTURE_C, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_BLACK_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block STANDING_BLACK_SIGN_D = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "black_standing_sign_d"),
            new TerraformSignBlock(SmallSignTextureHelper.BLACK_SIGN_TEXTURE_D, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_BLACK_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_BLACK_SIGN_D = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "black_wall_sign_d"),
            new TerraformWallSignBlock(SmallSignTextureHelper.BLACK_SIGN_TEXTURE_D, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_BLACK_SIGN).noCollision().noBlockBreakParticles()));
    ...
    public static final Block STANDING_ORANGE_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "orange_standing_sign_b"),
            new TerraformSignBlock(SmallSignTextureHelper.ORANGE_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_ORANGE_SIGN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_ORANGE_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "orange_wall_sign_b"),
            new TerraformWallSignBlock(SmallSignTextureHelper.ORANGE_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_ORANGE_SIGN).noCollision().noBlockBreakParticles()));
    ...
    public static final Block STANDING_YELLOW_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "yellow_standing_sign_b"),
            new TerraformSignBlock(SmallSignTextureHelper.YELLOW_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).dropsLike(STANDING_YELLOW_SIGN).sounds(BlockSoundGroup.CHAIN).noCollision().noBlockBreakParticles()));
    public static final Block WALL_YELLOW_SIGN_B = Registry.register(Registries.BLOCK, new Identifier(BigStationSigns.MOD_ID, "yellow_wall_sign_b"),
            new TerraformWallSignBlock(SmallSignTextureHelper.YELLOW_SIGN_TEXTURE_B, FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(STANDING_YELLOW_SIGN).noCollision().noBlockBreakParticles()));
    ...
    public static final Block ORANGE_BIG_STATION_SIGN_B = registerBlock("orange_big_sign_b",
            new GrayBigStationSign(FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(ORANGE_BIG_STATION_SIGN).noBlockBreakParticles().nonOpaque()));
    ...
    public static final Block YELLOW_BIG_STATION_SIGN_B = registerBlock("yellow_big_sign_b",
            new GrayBigStationSign(FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(YELLOW_BIG_STATION_SIGN).noBlockBreakParticles().nonOpaque()));
    ...
    public static final Block LIME_BIG_STATION_SIGN_B = registerBlock("lime_big_sign_b",
            new GrayBigStationSign(FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(LIME_BIG_STATION_SIGN).noBlockBreakParticles().nonOpaque()));
    ...
    public static final Block GREEN_BIG_STATION_SIGN_B = registerBlock("green_big_sign_b",
            new GrayBigStationSign(FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(GREEN_BIG_STATION_SIGN).noBlockBreakParticles().nonOpaque()));
    ...
    public static final Block CYAN_BIG_STATION_SIGN_B = registerBlock("cyan_big_sign_b",
            new GrayBigStationSign(FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(CYAN_BIG_STATION_SIGN).noBlockBreakParticles().nonOpaque()));
    ...
    public static final Block PURPLE_BIG_STATION_SIGN_B = registerBlock("purple_big_sign_b",
            new GrayBigStationSign(FabricBlockSettings.copyOf(Blocks.CHAIN).sounds(BlockSoundGroup.CHAIN).dropsLike(PURPLE_BIG_STATION_SIGN).noBlockBreakParticles().nonOpaque()));
