...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE)
                ...
                .add(ModBlocks.BLACK_BIG_STATION_SIGN_D)
                .add(ModBlocks.BROWN_BIG_STATION_SIGN)
                .add(ModBlocks.RED_BIG_STATION_SIGN)
                .add(ModBlocks.ORANGE_BIG_STATION_SIGN)
                .add(ModBlocks.ORANGE_BIG_STATION_SIGN_B)
                .add(ModBlocks.YELLOW_BIG_STATION_SIGN)
                .add(ModBlocks.YELLOW_BIG_STATION_SIGN_B)
                .add(ModBlocks.LIME_BIG_STATION_SIGN)
                .add(ModBlocks.LIME_BIG_STATION_SIGN_B)
                .add(ModBlocks.GREEN_BIG_STATION_SIGN)
                .add(ModBlocks.GREEN_BIG_STATION_SIGN_B)
                .add(ModBlocks.GREEN_BIG_STATION_SIGN_C)
                .add(ModBlocks.GREEN_BIG_STATION_SIGN_D)
                .add(ModBlocks.CYAN_BIG_STATION_SIGN)
                .add(ModBlocks.CYAN_BIG_STATION_SIGN_B)
                .add(ModBlocks.CYAN_BIG_STATION_SIGN_C)
                .add(ModBlocks.CYAN_BIG_STATION_SIGN_D)
                ...
                .add(ModBlocks.PURPLE_BIG_STATION_SIGN_C)
                .add(ModBlocks.PURPLE_BIG_STATION_SIGN_D)
